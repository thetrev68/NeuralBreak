...
const double initialObstacleSpeed =
    150.0; // Starting speed of falling obstacles
const double initialSpawnInterval =
    2.0; // Time between obstacle spawns (seconds)
const double obstacleSpeedIncreasePerLevel = 25.0; // Speed boost per level
const double spawnIntervalDecreasePerLevel =
    0.2; // Spawn rate acceleration per level
...
const double slideTapZoneHeight =
    100.0; // Tap zone height for slide (below player)
